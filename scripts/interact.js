const main = async () => {
  ...
  const description =
    "Remember your thoughts and ideas by creating an unique NFT, personalized as you wish. Mark memorable events by minting your customized NFT. Fully on-chain.";
